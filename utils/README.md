...
## 🌐 Web Security
* [🕷️ Simple Web Spider](spider.py) - DFS crawler to explore websites and find hidden flags within HTML anchors.
* [💉 SQLi Blind/Time-Based Automator](sqli_automator.py) - Script to extract flags character by character exploiting response times (`SLEEP`) or boolean inferences.
